...
This example uses [`first_package`](https://github.com/iotaledger/iota/tree/main/examples/move/first_package) Move package.

To get a summary of the test coverage, you must first run the `iota move test --coverage` command, and then the `iota move coverage summary --test` to get a summary of the test coverage in the example project.
