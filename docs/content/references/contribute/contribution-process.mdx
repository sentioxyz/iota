---
title: Contribute to IOTA Documentation
sidebar_label: Docs Contribution
description: Help the IOTA community through documentation contributions. Whether its to fix errors or add new content, the entire IOTA community benefits from your contributions.
---
...
Cloning the documentation locally is recommended when you are creating larger, more significant changes to the docs. See [IOTA Environment Setup](./iota-environment.mdx) for instructions on forking the IOTA repository, if necessary. The documentation is in the `docs/content` directory.
