...
- [SDK Repository](https://github.com/iotaledger/ts-sdks/tree/main/packages/deepbook-v3)
- [NPM version](https://www.npmjs.com/package/@iota/deepbook-v3)

## Install

To use the SDK in your projects, install the `@iota/deepbook` package.
