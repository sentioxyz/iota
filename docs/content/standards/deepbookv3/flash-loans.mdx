...
{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/pool.move#fun=borrow_flashloan_base noComments}
...
{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/pool.move#fun=borrow_flashloan_quote noComments}
...
{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/pool.move#fun=return_flashloan_base noComments}
...
{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/pool.move#fun=return_flashloan_quote noComments}
