...
{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/balance_manager.move#fun=new noComments}
...
{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/balance_manager.move#fun=mint_trade_cap,revoke_trade_cap}
...
{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/balance_manager.move#fun=generate_proof_as_owner,generate_proof_as_trader}

### Deposit funds

Only the owner can deposit funds into the `BalanceManager`.

{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/balance_manager.move#fun=deposit}

### Withdraw funds

Only the owner can withdraw funds from the `BalanceManager`.

{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/balance_manager.move#fun=withdraw,withdraw_all}

### Read endpoints

{@inject: github:iotaledger/deepbookv3/packages/deepbook/sources/balance_manager.move#fun=validate_proof,balance,owner,id}
