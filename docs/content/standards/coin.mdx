...
See [IOTA Tokenomics](../concepts/tokenomics.mdx) to learn more about the IOTA native coin and its use on the IOTA network.
...
See the [coin module](https://github.com/iotaledger/iota/blob/develop/crates/iota-framework/docs/iota/coin.md) documentation for all available options when creating a coin-type token on IOTA.
...
The [regulated-coin-sample repository](https://github.com/iotaledger/regulated-coin-sample) provides an example of regulated coin creation.
...
{@inject: crates/iota-framework/packages/iota-framework/sources/coin.move#fun=mint noComments}
...
{@inject: crates/iota-framework/packages/iota-framework/sources/coin.move#fun=burn noComments}
...
{@inject: crates/iota-framework/packages/iota-framework/sources/coin.move#fun=deny_list_v2_add noComments}
...
{@inject: crates/iota-framework/packages/iota-framework/sources/coin.move#fun=deny_list_v2_remove noComments}
...
You can use either the TypeScript or Rust SDK to manipulate the addresses held in the `DenyList` for your coin. The following examples are based on the [regulated coin sample](https://github.com/iotaledger/regulated-coin-sample).
...
{@inject: crates/iota-framework/packages/iota-framework/sources/coin.move#fun=deny_list_v2_enable_global_pause noComments}
...
{@inject: crates/iota-framework/packages/iota-framework/sources/coin.move#fun=deny_list_v2_disable_global_pause noComments}
...
- [`coin` module rustdoc documentation](https://github.com/iotaledger/iota/blob/develop/crates/iota-framework/docs/iota/coin.md): Automated documentation output for the IOTA framework `coin` module.
- [`token` module rustdoc documentation](https://github.com/iotaledger/iota/blob/develop/crates/iota-framework/docs/iota/token.md): Automated documentation output for the IOTA framework `token` module.
- [Tokenomics](../concepts/tokenomics.mdx): Discover the IOTA ecosystem and where IOTA coins fit within it.
