...
On IOTA, everything is an [object](../objects/object-model.mdx).
And, as objects in IOTA are unique, non-fungible, and owned, everything is a non-fungible token (NFT).
This means that a basic type publishing is enough to create a specific NFT.
