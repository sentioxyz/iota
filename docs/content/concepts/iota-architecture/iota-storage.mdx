---
title: IOTA Storage Cost
description: Historical data and the pricing of your storage solutions provide insights into the cost of your operations on the IOTA network.
---
...
Compute is a relatively fixed cost for Iota, with hundreds of validators running 24 Core, 128GB RAM machines.

Because IOTA is capable of such high throughput compared to other blockchains, the storage costs of running the IOTA network aren't as precise.
...
- [Custom Indexers](../../guides/developer/advanced/custom-indexer.mdx): Build custom indexers using the IOTA micro-data ingestion framework.
...
- [IOTA Archives](../../guides/operator/archives.mdx): Enable archiving on your Full nodes for a historical record of all transactions on IOTA.