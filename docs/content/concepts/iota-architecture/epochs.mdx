...
1. **Distribution of gas rewards**
    ...
    - Storage fees are allocated to a storage fund, playing a vital role in the IOTA tokenomics, as explained in [Tokenomics](../tokenomics.mdx).
