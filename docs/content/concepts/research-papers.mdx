...
This document contains a list of research papers that are relevant to IOTA and have been co-authored by at least one member of the team.
...
but could be integrated in the future. Start with the [IOTA Smart Contract Platform](/doc/iota.pdf) white paper, which contains
our latest design inspired by previous works below.

<div class="bg-iota-blue-light dark:bg-iota-gray-95 p-8 rounded-lg border border-solid border-iota-blue-dark">

<p class="text-iota-gray-80 text-xl font-bold italic">Latest</p>
