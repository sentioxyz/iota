---
title: IOTA Node Monitoring
description: Monitor IOTA node metrics to ensure the health and performance of your node.
---
...
```sh
$ curl -s http://localhost:9184/metrics | grep -E 'iota_validator|iota_fullnode'
```
