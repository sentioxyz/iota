---
title: Querying IOTA RPC with GraphQL (Alpha)
description: Introductory guide to making queries of the IOTA RPC using the GraphQL service.
---
...
For more details about some concepts used in the examples below, please see the [GraphQL concepts](../../../concepts/graphql-rpc.mdx) page, and consult the [reference](../../../references/iota-graphql.mdx) for full documentation on the supported schema.
...
- [IOTA Testnet GraphiQL](https://iota-testnet.iota.org/graphql): IOTA GraphiQL IDE for the Testnet network.
- [IOTA Mainnet GraphiQL](https://iota-mainnet.iota.org/graphql): IOTA GraphiQL IDE for the Mainnet network.
