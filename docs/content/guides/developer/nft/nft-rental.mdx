...
- [NFT Rental example](https://github.com/iotaledger/iota/tree/main/examples/move/nft-rental): The source code that this document references.
- [IOTA Kiosk](../../../standards/kiosk.mdx): Kiosk is a decentralized system for commerce applications on IOTA.
- [Kiosk Apps](../../../standards/kiosk-apps.mdx): The Kiosk Apps standard extends the functionality of IOTA Kiosk.  
