...
- [Source code](https://github.com/iotaledger/iota/blob/main/examples/move/token/sources/loyalty.move): The source code in GitHub for this example.
- [In-Game Tokens](./in-game-token.mdx): Example of how to create tokens for use as in-game currency.
- [Regulated Coin and Deny List](./regulated.mdx): Example of how to create regulated coins on the IOTA network.