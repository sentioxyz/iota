...
For a comprehensive list of all available GraphQL features, consult the [reference](../../../references/iota-graphql).
...
The goal is to find all versions of the IOTA framework, and list their modules:
