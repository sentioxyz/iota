...
- For a complete list of the current limits defined in the Protocol Config, see [this](https://github.com/iotaledger/iota/blob/develop/crates/iota-protocol-config/src/lib.rs#L731).
...
See [this](https://github.com/iotaledger/iota/blob/main/examples/move/random/random_nft/sources/example.move#L117-L142) for example implementation.
...
- [IOTA Framework Reference](../../../references/framework)
  - <a href="/references/framework/iota-framework/random" data-noBrokenLinkCheck="true">
    	random.move
    </a>
- [Raffle example](https://github.com/iotaledger/iota/blob/main/examples/move/random/raffles)
- [IOTA Client CLI](../../../references/cli/client)
