...
description: Learn how to mint coins and tokens on the IOTA network.
---
...
Publishing a coin on IOTA is similar to publishing a new type. The main difference is the requirement of a one time witness when creating a coin.
...
- [Stablecoins](./stablecoins): The IOTA network has native stablecoins, including USDC.
