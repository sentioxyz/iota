    ...
    let validator_service = Service::builder()
        ...
        .method(
            Method::builder()
                ...
                .input_type("iota_types::messages_grpc::HandleTransactionRequestV2")
                .output_type("iota_types::messages_grpc::HandleTransactionResponseV2")
                .codec_path(codec_path)
                .build(),
        )
        .method(
    ...
    let state_sync = anemo_build::manual::Service::builder()
        ...
        .method(
            anemo_build::manual::Method::builder()
                ...
                .response_type("Option<iota_types::messages_checkpoint::CertifiedCheckpointSummary>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
