...
pub struct Object {
    ...
    /// The amount of IOTA to rebate if this object gets deleted.
...
pub struct SimpleSignature {
    ...
    /// enum value of [iota.types.SignatureScheme][iota.types.SignatureScheme]
