...
impl From<iota_sdk_types::Event> for super::Event {
    fn from(value: iota_sdk_types::Event) -> Self {
        Self {
...
impl TryFrom<&super::Event> for iota_sdk_types::Event {
...
impl From<iota_sdk_types::TransactionEvents> for super::TransactionEvents {
    fn from(value: iota_sdk_types::TransactionEvents) -> Self {
        Self {
...
impl TryFrom<&super::TransactionEvents> for iota_sdk_types::TransactionEvents {
    type Error = TryFromProtoError;
