...
impl From<iota_sdk_types::ObjectReference> for super::ObjectReference {
...
impl TryFrom<&super::ObjectReference> for iota_sdk_types::ObjectReference {
...
impl From<iota_sdk_types::Object> for super::Object {
    fn from(value: iota_sdk_types::Object) -> Self {
        Self {
...
impl TryFrom<&super::Object> for iota_sdk_types::Object {
    type Error = TryFromProtoError;
...
impl TryFrom<&super::Owner> for iota_sdk_types::Owner {
    type Error = TryFromProtoError;
...
impl TryFrom<&super::ObjectData> for iota_sdk_types::ObjectData {
    type Error = TryFromProtoError;
...
impl From<iota_sdk_types::MoveStruct> for super::MoveStruct {
    fn from(value: iota_sdk_types::MoveStruct) -> Self {
        Self {
            object_id: Some(value.object_id().into()),
...
impl TryFrom<&super::MoveStruct> for iota_sdk_types::MoveStruct {
    type Error = TryFromProtoError;
...
impl From<iota_sdk_types::MovePackage> for super::MovePackage {
    fn from(value: iota_sdk_types::MovePackage) -> Self {
        let modules = value
            .modules
            .into_iter()
...
impl TryFrom<&super::MovePackage> for iota_sdk_types::MovePackage {
    type Error = TryFromProtoError;
...
impl From<iota_sdk_types::TypeOrigin> for super::TypeOrigin {
    fn from(value: iota_sdk_types::TypeOrigin) -> Self {
        Self {
...
impl TryFrom<&super::TypeOrigin> for iota_sdk_types::TypeOrigin {
    type Error = TryFromProtoError;
...
impl From<iota_sdk_types::GenesisObject> for super::GenesisObject {
    fn from(value: iota_sdk_types::GenesisObject) -> Self {
        Self {
            object_id: Some(value.object_id().into()),
            version: Some(value.version()),
            owner: Some(value.owner().to_owned().into()),
...
impl TryFrom<&super::GenesisObject> for iota_sdk_types::GenesisObject {
    type Error = TryFromProtoError;
