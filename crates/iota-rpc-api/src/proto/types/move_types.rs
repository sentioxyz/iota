...
impl From<iota_sdk_types::Identifier> for super::Identifier {
    fn from(value: iota_sdk_types::Identifier) -> Self {
        Self {
...
impl TryFrom<&super::Identifier> for iota_sdk_types::Identifier {
...
impl From<iota_sdk_types::StructTag> for super::StructTag {
    fn from(value: iota_sdk_types::StructTag) -> Self {
        Self {
...
impl TryFrom<&super::StructTag> for iota_sdk_types::StructTag {
    type Error = TryFromProtoError;
...
impl From<iota_sdk_types::TypeTag> for super::TypeTag {
    fn from(value: iota_sdk_types::TypeTag) -> Self {
...
impl TryFrom<&super::TypeTag> for iota_sdk_types::TypeTag {
    type Error = TryFromProtoError;
