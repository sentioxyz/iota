...
async fn test_iota_operations_config() {
    ...
    assert!(read.is_ok());
    assert_eq!(
        IotaAddress::from_str("7d20dcdb2bca4f508ea9613994683eb4e76e9c4ed371169677c1be02aaf0b58e")
            .unwrap(),
    ...
    assert_eq!(
        IotaAddress::from_str("160ef6ce4f395208a12119c5011bf8d8ceb760e3159307c819bd0197d154d384")
            .unwrap(),
        read.unwrap().addresses()[0]
    );
}
