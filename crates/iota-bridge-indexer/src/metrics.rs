    ...
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            last_committed_iota_checkpoint: register_int_gauge_with_registry!(
                "bridge_indexer_last_committed_iota_checkpoint",
